export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wxc90fcbd0b20dd3e3",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "8cade9be4f7eaef637d1976b132f6dba",
  ...
  USERS: ["ohBZz6MblsF-_WGgr2IxCpaLd184"]
    {
      ...
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "	z_Y9KPBDcQwgYld5FOkLP9w1mjldi79BDDHmHmRtVrQ",
      // 所在省份
      province: "贵州",
      // 所在城市
      city: "贵阳",
      ...
      openUrl: "https://m.weibo.cn/u/1658035485",
